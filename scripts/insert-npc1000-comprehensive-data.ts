  ...
  try {
    ...
    const materialsToInsert = [
      ...
      },
      {
        ...
        unit_price: 92000,
        supplier: '삼표레미콘',
        specifications: { strength: '27MPa', slump: '120mm', aggregate_size: '25mm' },
        npc_1000_code: 'C001002',
        is_active: true
      },
      {
        ...
        unit_price: 98000,
        supplier: '현대레미콘',
        specifications: { strength: '30MPa', slump: '100mm', aggregate_size: '20mm' },
        npc_1000_code: 'C001003',
        is_active: true
      },
      {
        ...
        unit_price: 125000,
        supplier: '삼표레미콘',
        specifications: { strength: '40MPa', slump: '80mm', aggregate_size: '20mm' },
        npc_1000_code: 'C001004',
        is_active: true
      },
      {
        ...
        unit_price: 95000,
        supplier: '한일시멘트',
        specifications: { strength: '24MPa', slump: '120mm', waterproof: 'Type A' },
        npc_1000_code: 'C001005',
        is_active: true
      },
      ...
      // 철근 관련 자재
      {
        ...
        unit_price: 920000,
        supplier: '현대제철',
        specifications: { grade: 'SD400', diameter: '13mm', length: '12m' },
        npc_1000_code: 'R002001',
        is_active: true
      },
      {
        name: 'SD400 이형철근 D16',
        ...
        unit_price: 915000,
        supplier: '포스코',
        specifications: { grade: 'SD400', diameter: '16mm', length: '12m' },
        npc_1000_code: 'R002002',
        is_active: true
      },
      {
        name: 'SD400 이형철근 D19',
        ...
        unit_price: 910000,
        supplier: '현대제철',
        specifications: { grade: 'SD400', diameter: '19mm', length: '12m' },
        npc_1000_code: 'R002003',
        is_active: true
      },
      {
        ...
        unit_price: 950000,
        supplier: '포스코',
        specifications: { grade: 'SD500', diameter: '22mm', length: '12m' },
        npc_1000_code: 'R002004',
        is_active: true
      },
      {
        ...
        unit_price: 945000,
        supplier: '현대제철',
        specifications: { grade: 'SD500', diameter: '25mm', length: '12m' },
        npc_1000_code: 'R002005',
        is_active: true
      },
      ...
      // 골재 관련 자재
      {
        ...
        unit_price: 18000,
        supplier: '대한골재',
        specifications: { size: '20-5mm', grade: '1종', density: '1.65t/m³' },
        npc_1000_code: 'A003001',
        is_active: true
      },
      {
        name: '쇄석 25-5mm (1종)',
        ...
        unit_price: 17500,
        supplier: '동양골재',
        specifications: { size: '25-5mm', grade: '1종', density: '1.65t/m³' },
        npc_1000_code: 'A003002',
        is_active: true
      },
      {
        name: '강모래 (세척사)',
        ...
        unit_price: 22000,
        supplier: '한강골재',
        specifications: { type: '세척사', fineness: '2.6', density: '1.55t/m³' },
        npc_1000_code: 'A003003',
        is_active: true
      },
      {
        name: '바다모래 (세척사)',
        ...
        unit_price: 25000,
        supplier: '서해골재',
        specifications: { type: '세척사', fineness: '2.7', density: '1.58t/m³' },
        npc_1000_code: 'A003004',
        is_active: true
      },
      ...
      // 시멘트 관련 자재
      {
        ...
        unit_price: 95000,
        supplier: '한라시멘트',
        specifications: { type: '1종', strength: '42.5MPa', fineness: '3200cm²/g' },
        npc_1000_code: 'C004001',
        is_active: true
      },
      {
        name: '고로슬래그 시멘트 3종',
        ...
        unit_price: 88000,
        supplier: '쌍용C&E',
        specifications: { type: '3종', slag_content: '60%', strength: '32.5MPa' },
        npc_1000_code: 'C004002',
        is_active: true
      },
      ...
      // 기타 자재
      {
        ...
        unit_price: 35000,
        supplier: '동화기업',
        specifications: { thickness: '12mm', size: '1200x2400mm', grade: 'WBP' },
        npc_1000_code: 'O005001',
        is_active: true
      },
      {
        name: '각목 50x100mm',
        ...
        unit_price: 4500,
        supplier: '삼성목재',
        specifications: { section: '50x100mm', grade: '1급', moisture: '18%' },
        npc_1000_code: 'O005002',
        is_active: true
      },
      {
        ...
        unit_price: 8500,
        supplier: '대한철망',
        specifications: { diameter: '6mm', mesh: '200x200mm', sheet_size: '2x3m' },
        npc_1000_code: 'R002006',
        is_active: true
      }
    ]
